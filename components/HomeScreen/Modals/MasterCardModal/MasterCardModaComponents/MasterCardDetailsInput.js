...
const MasterCardDetailsInput = ({onBackPress}) => {

  const { userMasterCard, setUserMasterCard,  } = usePaymentContext();
  ...
  const handleCardNumberChange = (value) => {
    setUserMasterCard({ ...userMasterCard, cardNumber: value });
  };

  const handleCCVChange = (value) => {
    setUserMasterCard({ ...userMasterCard, ccv: value });
  };

  const masterCardImage = require('../../../../../assets/icons/masterCard.png');

  return (
    <View style={styles.container}>
      <ModalsHeader
        headerTitle={'MasterCard Details'}
        headerImage={masterCardImage}
      ...
      <TextInput
        ...
        value={userMasterCard.cardNumber}
...
export default MasterCardDetailsInput;
