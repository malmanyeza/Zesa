...
const BankOptions = () => {
  const { setBankOption, bankOptionIndex, setBankOptionIndex, setUserBankAccount,userBankAccount, bankOptions, } = usePaymentContext();
...
export default memo(BankOptions);
